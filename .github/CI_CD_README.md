...
**Trigger:** Push/PR to any branch modifying `.github/**` (excluding `*.md` files and `.github/notify-telegram-HTMLCSS-preview/**`)
**Jobs:**
...
**Path ignore:** `**/*.md`, `docs/**`, `.github/notify-telegram-HTMLCSS-preview/**`
**Jobs:**
