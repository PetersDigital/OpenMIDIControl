...
- **MidiParser Extraction** (`15f8ee8`): UMP reconstruction logic extracted from `MainActivity.kt` into isolated, testable `MidiParser.kt` for comprehensive unit testing.
