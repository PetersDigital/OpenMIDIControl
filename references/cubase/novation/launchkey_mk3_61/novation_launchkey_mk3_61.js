...
deviceDriver
  .makeDetectionUnit()
  .detectPortPair(midiInput, midiOutput)
  .expectInputNameEquals('Launchkey MK3 61 LKMK3 DAW Out')
  .expectOutputNameEquals('Launchkey MK3 61 LKMK3 DAW In');
...
deviceDriver.mOnActivate = function (context) {
  ...
  console.log('INIT Launchkey Integration LK61');
};
...
function makeKeyboard(s) {
  const features = {};
  features.keys = s.makePianoKeys(6, 9, 67, 8, 0, 60);
